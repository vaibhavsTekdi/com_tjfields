...
/**
 * View class for editing country.
 *
 * @package     Tjfields
 * @subpackage  com_tjfields
 * @since       2.2
 */
class TjfieldsViewCountry extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		if ($isNew)
		{
			$viewTitle = $viewTitle . ': ' . JText::_('COM_TJFIELDS_ADD_COUNTRY');
		}
		else
		{
			$viewTitle = $viewTitle . ': ' . JText::_('COM_TJFIELDS_EDIT_COUNTRY');
		}
		...
		{
			JToolBarHelper::title($viewTitle, 'country.png');
		}
