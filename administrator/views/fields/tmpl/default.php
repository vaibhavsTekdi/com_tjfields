...
<div class="techjoomla-bootstrap">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_tjfields&view=fields&client='.$input->get('client','','STRING')); ?>" method="post" name="adminForm" id="adminForm">
				...
				<?php if(JVERSION >= '3.0'):?>
					<!--Group Filter-->
					<div class="filter-group btn-group pull-left">
						<label for="filter_search" class="element-invisible"><?php echo JText::_('JSEARCH_FILTER');?></label>
					<?php
					echo JHtml::_('select.genericlist', $this->groups, 'filter_group','onchange="document.adminForm.submit();"','value', 'text',$this->group_id); ?>
					</div>
					<!--Group Filter-->
			...
			<table class="table table-striped" id="fieldList">
				<thead>
					...
					<th class='left'>
					<?php  echo JHtml::_('grid.sort',  'COM_TJFIELDS_GROUPS', 'a.groupname', $listDirn, $listOrder);  ?>
					</th>
